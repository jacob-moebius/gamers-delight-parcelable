...
public class GameListAdapter extends ArrayAdapter<Game> {
    ...
    public View getView(int pos, View convertView, ViewGroup parent)
    {
        ...
        LinearLayout gameListLinearLayout =
                view.findViewById(R.id.gameListLinearLayout);
        ImageView gameListImageView =
                view.findViewById(R.id.gameListImageView);
        TextView gameListNameTextView =
                view.findViewById(R.id.gameListNameTextView);
        TextView gameListDescriptionTextView =
                view.findViewById(R.id.gameListDescriptionTextView);
        RatingBar gameListRatingBar =
                view.findViewById(R.id.gameListRatingBar);
